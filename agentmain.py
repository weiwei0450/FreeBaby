...
from ga import FreeBabyHandler, smart_format, get_global_memory, format_error, consume_file
...
class GeneraticAgent:
    ...
    def run(self):
        while True:
            ...
            handler = FreeBabyHandler(self, self.history, os.path.join(script_dir, 'temp'))
